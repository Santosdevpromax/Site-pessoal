...
async function saveDataToFirestore() {
  ...
  siteData.projects = Array.from(projCards).map((card, idx) => ({
    ...
    imageUrl: card.querySelector(".proj-img-url").value || (siteData.projects[idx] ? siteData.projects[idx].imageUrl : ""),
